  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        <Link to={user?.role === 'admin' ? "/admin" : "/"} className="text-3xl font-black tracking-tighter text-white hover:opacity-80 transition-opacity">
          ...
          {user ? (
            <>
              ...
              <div className="flex items-center gap-4">
                <Link to={user.role === 'admin' ? "/admin" : "/dashboard"} className="flex items-center gap-3 p-1.5 pr-4 bg-white/5 rounded-xl border border-white/10 hover:border-primary-500/30 transition-all group">
